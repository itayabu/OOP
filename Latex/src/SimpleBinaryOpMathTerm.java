...
public class SimpleBinaryOpMathTerm extends BinaryMathTerm {
	...
	/**
	 * Instantiate a new SimpleBinaryOpMathTerm. Keep in mind that since this class extends BinaryMathTerm, 
	 * and BinaryMathTerm can not be instantiated without parameters (no default constructor), 
	 * this constructor should call its superclass constructor explicitly (As seen in class, using super() keyword).
