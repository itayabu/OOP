...
public class InstanceArrayValidator {
	 ...
	 * @return
	 */
	public static boolean instanceNameExistInBlock(Instance checkInstance, ArrayList<Instance> instanceInBlock){
	 ...
	 */
	public static Instance findInstance(ArrayList<ArrayList<Instance>> list, String s){
